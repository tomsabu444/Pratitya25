    ...
    <div className="flex gap-4 justify-center items-center">
      {timeBlocks.map((block, index) => (
        <div key={index} className="flex flex-col items-center">
          ...
          <span className="text-[#8A8F98] mt-4 text-lg tracking-widest">
            {block.label}
          </span>
        </div>
      ))}
...
const ParallaxPage = () => {
  ...
  const lanternPositions = [
    {
      desktop: { left: "5%", top: "15%" },
      mobile: { left: "10%", top: "15%" },
    },
    {
      desktop: { left: "15%", top: "70%" },
      mobile: { left: "75%", top: "20%" },
    },
    {
      desktop: { left: "35%", top: "40%" },
      mobile: { left: "40%", top: "25%" },
    },
    {
      desktop: { left: "65%", top: "20%" },
      mobile: { left: "60%", top: "30%" },
    },
    {
      desktop: { left: "70%", top: "60%" },
      mobile: { left: "25%", top: "35%" },
    },
  ];
  ...
  return (
    <div>
      <div
        ref={containerRef}
        className="relative h-[300vh] overflow-hidden bg-[#1a1a1a]"
      >
        {/*//! First Section */}
